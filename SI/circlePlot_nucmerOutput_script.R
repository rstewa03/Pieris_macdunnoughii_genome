...
## e.g. myalignment.filt.coords 0.90 5000 myprefix
...
# [1] reference vs. query with minimum reference scaffold length of 1Mbp
...
# [4] reference vs. query with minimum scaffold length of 2Mbp for both the reference and query


# To reproduce query and reference naming in figure 2, see the ref_order, qry_order modifications at the end of the script
...
t_per <- if_else(is.na(args[4]), 0.9, as.numeric(args[4]))
t_per <- if_else(t_per<1 & t_per>0, t_per, 0.9)
